...
import 'package:vox_guard/screens/safety/start_trip_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Future<void> _determinePosition() async {
    ...
    if (!serviceEnabled) {
      setState(() => _locationText = "GPS is disabled");
      return;
    }
...
Widget build(BuildContext context) {
  return Scaffold(
    body: Container(
      ...
      child: _selectedIndex == 0 ? _buildHomeContent() : _pages[_selectedIndex],
    ),
 ...
 Widget _buildHomeContent() {
  ...
  // ================= UI COMPONENTS (Modified for Navigation) =================
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Center(
                      child: Text('SOS', style: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ),
              ],
